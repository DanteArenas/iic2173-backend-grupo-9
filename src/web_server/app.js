...
// ---- Helpers DB: asegurar cambios mínimos de esquema
async function ensureDbSchemaUpgrades() {
  try {
    ...
    console.log('✅ Esquema verificado: columnas retry_used / invoice_url listas.');
  } catch (err) {
    ...
    try {
      ...
      try {
        ...
        if (requestRow) {
          ...
          // si fracasó el pago, devolvemos la visita
